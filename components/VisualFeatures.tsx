...
{/* Card 3: Templates */}
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="w-32 h-44 bg-slate-900 rounded-xl border border-white/10 -rotate-6 group-hover:-rotate-12 transition-transform duration-500  flex flex-col p-4 gap-3">
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-8 right-8">
        ...
        <p className="text-sm text-slate-500 group-hover:text-slate-400 transition-colors z-12">{description}</p>
      </div>
    </motion.div>
  );
}
